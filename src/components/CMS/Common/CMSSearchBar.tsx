  ...
  return (
    <div className={`relative group ${className || "w-64"}`}>
      ...
      <input
        ...
        className="pl-10 pr-4 py-2 bg-white border border-slate-200 rounded-lg text-xs font-bold focus:outline-none focus:ring-2 focus:ring-brand-500/5 focus:border-brand-500 w-full transition-all placeholder:text-slate-300"
      />
    </div>
  );
};
