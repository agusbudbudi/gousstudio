...
const CMSButton: React.FC<CMSButtonProps> = ({
  ...
  const baseStyles =
    "flex items-center justify-center gap-2 transition-colors font-bold text-xs active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer";

  const variantStyles = {
    primary:
      "px-4 py-2 bg-brand-500 hover:bg-brand-600 text-white rounded-lg  ",
    secondary:
